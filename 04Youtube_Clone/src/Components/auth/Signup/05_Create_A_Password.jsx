  ...
  return (
    ...
    <div className="flex justify-between w-full">
      ...
      <div className="space-y-5 w-[50%]">
        <h1 className="text-4xl font-montserrat tracking-tight font-[450]">Create a strong password</h1>
      ...
      <div className="flex flex-col justify-end items-end gap-y-5 w-[50%] ">
        ...
        <Link to="review_account"><button className="mt-10 bg-[#346fc6] font-semibold text-sm px-6 pt-2 pb-2.5 text-white rounded-full hover:bg-[#1d67d5] hover:shadow-md">Next</button></Link>
      </div>
    </div>
  )
}

export default Create_A_Password